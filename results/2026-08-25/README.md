# U=8 N=100 P-P campaign (2026-08-25)

Results for the new N=100 BNS injection probability-probability campaign.
Configuration: sharded real-PE fast-ridge, M=2 Gibbs sweeps, D=4 devices,
joint (cos iota, d_hat) slice block, analytic phi_c and t_c marginalization,
and U=8 local ZoomFFT time interpolation. Paper reference:
arXiv:2607.28265v1.

Result: the Fisher-combined exact one-sample KS test gives p = 0.873 over 15
parameters. The post-JIT sampling time has median 56.1 s per injection on 4x
